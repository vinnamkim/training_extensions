...
from otx.v2_single_engine.data_entity.detection import (
    DetBatchDataEntity,
    DetBatchPredEntity,
)
from otx.v2_single_engine.model.base import OTXLitModule, OTXModel
        ...
        return {
            "preds": [
                ...
                for bboxes, scores, labels in zip(
                    preds.bboxes, preds.scores, preds.labels,
                )
            ],
            "target": [
                {
