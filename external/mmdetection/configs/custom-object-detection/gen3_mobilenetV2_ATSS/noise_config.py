...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file='/mnt/ssd2/sc_datasets_det/pklot/annotations/instances_train_noise.json',
            img_prefix='/mnt/ssd2/sc_datasets_det/pklot/images/train',
            classes=classes,
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file='/mnt/ssd2/sc_datasets_det/pklot/annotations/instances_val.json',
        img_prefix='/mnt/ssd2/sc_datasets_det/pklot/images/val',
        test_mode=True,
        classes=classes,
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file='/mnt/ssd2/sc_datasets_det/pklot/annotations/instances_test.json',
        img_prefix='/mnt/ssd2/sc_datasets_det/pklot/images/test',
        test_mode=True,
        classes=classes,
        pipeline=test_pipeline))
